...
use App\Actions\PaginateUnfinishedMaterialsAction;
use App\Http\Controllers\Controller;
use App\Http\Requests\XHR\PaginateFilteredMaterialsRequest;
use Illuminate\Http\JsonResponse;

class PaginateUnfinishedMaterialsListController extends Controller
{
    /**
     * Get HTML data for material paginator
     *
     * @param PaginateFilteredMaterialsRequest $request
     * @param PaginateUnfinishedMaterialsAction $action
     * @return JsonResponse
     */
    public function __invoke(
        PaginateFilteredMaterialsRequest $request,
        PaginateUnfinishedMaterialsAction $action
    ): JsonResponse
    {
