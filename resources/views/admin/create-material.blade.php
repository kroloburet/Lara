<x-layouts.base
        :title='__("admin.{$type}.add.meta_title")'
        :description='__("admin.{$type}.add.meta_desc")'
>
    <x-layouts.admin.base>

        <h1>{!! __("admin.{$type}.add.page_title") !!}</h1>
        ...
        <form id="fetchFormData">
            <dl class="UI_Tabs">
                ...
                <dd>
                    ...
                    <x-admin.bg-image-component :materialType="$type" />

                    <x-form.layout-component :materialType="$type" />
                </dd>
        ...
        <script>
            document.addEventListener(`DOMContentLoaded`, () => {
                ...
                new Material({
                    action: `update`,
                    type: `{{ $type }}`,
                    actionURL: `{{ route('xhr.admin.create.material') }}`,
                    ...
                    collection: [
                        ...
                        form.querySelector(`:scope #bgImageComponent`),
