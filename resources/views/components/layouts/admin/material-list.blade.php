    ...
    <div class="Paginator_item">
        ...
        <div class="Paginator_item-control">
            ...
            @can('permits', ['material', 'u'])
                <a href="{{ route('admin.update.material',
                        [
                            'type' => $material->type,
                ...
                <a class="togglePublicMaterial fa-solid
                    {{ $material->isBlocked() ? 'fa-eye-slash red-text' : 'fa-eye' }}"
                   data-type="{{ $material->type }}"
                   data-alias="{{ $material->alias }}"
                   title="{{ __("base.Toggle_public") }}"></a>
            @endcan

            @can('permits', ['material', 'd'])
                <a class="fa-solid fa-trash-can delMaterial"
                   data-type="{{ $material->type }}"
                   data-alias="{{ $material->alias }}"
